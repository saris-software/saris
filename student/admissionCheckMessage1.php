...
if ($totalRows_studentsuggestion > 0) {
    ...
    Your Messages: <span
            class="style64 style1">...............</span><?php print "<a href=\"admissionSuggestionBox.php\">Reply Message</a>" ?>
    ...
    <p>
        ...
        of <?php echo $totalRows_studentsuggestion ?> <span class="style64">...</span><a
