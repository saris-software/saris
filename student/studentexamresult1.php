    ...
    while ($rowayear = mysqli_fetch_object($dbayear)) {
        ...
        <table width="100%" height="100%" border="2" cellpadding="0" cellspacing="0">
                ...
                if (($coption == 2) && (number_format($tmarks, 0) < 10)) {
                    ...
                    <tr>
                        ...
                        <td width="30" nowrap scope="col">
                            <div align="center"><?php if ($test2score <> -1) {
                                    echo $test2score;
                                } ?></div>
                        </td>
                        <td width="30" nowrap scope="col">
                            <div align="center"><?php echo $aescore; ?></div>
                        </td>
                        <td width="30" nowrap scope="col">
                            <div align="center"><?php echo $marks; ?></div>
                        </td>
                        <td width="30" nowrap scope="col">
            ...
            <tr>
                ...
                <td width="30" nowrap bgcolor="#CCCCCC" scope="col">
