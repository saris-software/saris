...
$query_studentsuggestion = "SELECT sg.received, sg.fromid, sg.toid, sg.message, sc.FullName FROM suggestion sg, security sc 
							WHERE sg.toid = '$RegNo' AND sc.RegNo=sg.fromid ORDER BY received DESC";
...
Your Messages: <span class="style64 style1">...............</span>
<?php  print "<a href=\"admissionSuggestionBox.php?ID=".$row_studentsuggestion['fromid']."&name=".$row_studentsuggestion['FullName']."\">Reply Message</a>"?> 
<table width="721" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?php echo $row_studentsuggestion['FullName']; ?></td>
            </tr>
            <tr>
