...
mysqli_select_db($zalongwa,$database_zalongwag);
...
<div align="center">
  <center>
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#990000">
      ...
      <tr>
        <td width="56" rowspan="5" valign="top"><table width="62%" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" bgcolor="#99CCCC">
          <tr class="style35">
      ...
      <tr>
        <td width="671" valign="top"><div align="left">	
          <form action="/accommodation/housingeditnorminalreport.php" method="POST" name="editnorminorol" id="editnorminorol">
            <table width="284" border="0">
        <tr>
          <td colspan="2" nowrap><span class="style65">...Select Nominal Roll to Edit </span> <hr></td>
          </tr>
        <tr>
...
?>
        ...
        <tr>
          ...
          <td bgcolor="#CCCCCC"><input type="submit" name="Submit" value="Print Report"></td>
                    ...
                    <input name="MM_edit" type="hidden" id="MM_edit" value="housingeditnominalrol">
          </form>
                    <hr>
        </div></td>
