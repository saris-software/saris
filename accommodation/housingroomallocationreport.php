  ...
  <center>
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#990000">
      ...
      <tr>
        ...
        <td height="57" align="left" valign="top"><span class="style42"><span class="style64"><font face="Verdana">Welcome</font></span><span class="style29"><font face="Verdana"> --&gt; </font></span><span class="style24"><font face="Verdana"><b>Login --&gt; <a href="/accommodation/housingindex.php">Start Page</a> </b></font></span>--&gt; Room Allocation</span>
          <form action="/accommodation/housingroomallocationsearchreport.php" method="get" class="style24">
...
$sql = "SELECT student.Name, allocation.RegNo, hostel.HName, allocation.RNumber, allocation.AYear, hostel.HID
