  ...
  <center>
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#990000">
      ...
      <tr>
        ...
        <td height="43" nowrap><div align="right"><form action="/accommodation/housingroomallocationsearchreport.php" method="get" class="style24">
            <div align="right"><span class="style67"><font face="Verdana">Search</font></span> 
...
$sql = "SELECT student.Name, student.Sex, student.ProgrammeofStudy, student.Faculty, student.Sponsor, student.EntryYear, student.RegNo, hostel.HName, allocation.RNumber, allocation.AYear, hostel.HID
