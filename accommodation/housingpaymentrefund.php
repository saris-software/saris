  ...
  // Add send functionality here
		...
		if(!empty($receiptno)){
			if(intval($category)==0){
			  ...
			  <fieldset>
				<legend>Refund Registration Form</legend>
							 ...
							 <select name="category" id="category">
							  <option value="0">[Select Category]</option>
								<optgroup label="Accommodation Office">
								  <option value="10">Refund Accom. Rental Charges</option>
								  <option value="11">Refund Accom. Caution Fees</option>
								  <option value="12">Refund Accom. Penalty Charges</option>
								</optgroup>
								<optgroup label="Admission Office">
								  <option value="13">Refund Univ. Tuition Fees</option>
								  <option value="14">Refund Univ. Caution Fees</option>
								  <option value="15">Refund Univ. Penalty Charges</option>
								</optgroup>
								<optgroup label="Examination Office">
								  <option value="16">Refund Exam. Transcript Fees</option>
								  <option value="17">Refund Exam. Certificate Fees</option>
								  <option value="18">Refund Exam. Appeal Fees</option>
								</optgroup>
							   </select>
						   ')?>
					</td>
