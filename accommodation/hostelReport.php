...
<table border="1" cellpadding="1" cellspacing="0">
  ...
  <tr>
    ...
    <td nowrap><?php $hid=$row_inst['HID']; 
	$qhostel = "SELECT HName from hostel where HID = '$hid'";
	$dbhostel = mysql_query($qhostel);
	$row_hostel=mysql_fetch_assoc($dbhostel);
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="frmInstEdit" id="frmInstEdit">
  <table width="200" border="1" cellpadding="0" cellspacing="0" bordercolor="#006600">
    <tr bgcolor="#CCCCCC">
      <th nowrap scope="row"><div align="right">Room Number:</div></th>
      <td><?php echo $row_instEdit['RNumber']; ?><input name="txtName" type="hidden" value="<?php echo $row_instEdit['RNumber']; ?>"></td>
    </tr>
    <tr bgcolor="#CCCCCC">
      <th nowrap scope="row"><div align="right">Capacity:</div></th>
      <td><input name="txtAdd" type="text" id="txtAdd" value="<?php echo $row_instEdit['Capacity']; ?>" size="40" ></td>
    </tr>
    <tr bgcolor="#CCCCCC">
      <th nowrap scope="row"><div align="right">Hostel: </div></th>
      <td><?php echo $row_instEdit['HID']; ?><input name="txtPhyAdd" type="hidden" id="txtPhyAdd" value="<?php echo $row_instEdit['HID']; ?>" size="40" ></td>
    </tr>
    <tr bgcolor="#CCCCCC">
      <th nowrap scope="row"><div align="right">Block:</div></th>
      <td><input name="txtTel" type="text" id="txtTel" value="<?php echo $row_instEdit['BID']; ?>" size="40" ></td>
    </tr>
    <tr bgcolor="#CCCCCC">
      <th nowrap scope="row"><div align="right"> Floor:</div></th>
      <td><input name="txtEmail" type="text" id="txtEmail" value="<?php echo $row_instEdit['FloorName']; ?>" size="40" ></td>
    </tr>
    <tr bgcolor="#CCCCCC">
