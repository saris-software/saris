...
*/ 
	...
	global $szSection, $szSubSection, $szSubSubSection,$intSubSectionID, $intSectionID, $szSubSubSectionTitle,$szSubSectionTitle, $szTitle, $additionalStyleSheet, $arrStructure, $szRootURL, $blnHideNav, $arrVariations;
...
<table border="0" cellspacing="0" cellpadding="0" width=100% height=50% style="border:2px solid rgb(119,119,119)">
<tr>
</tr>
<tr><td height=30 colspan=2 bgcolor="#CCCCCC" class="style2">
