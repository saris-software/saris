...
$Result1 = mysqli_query($zalongwa,$sql) or die(mysqli_error());
...
$changepassword = mysqli_query($zalongwa,$query_changepassword) or die(mysqli_error());
...
if (fmAdd.txtoldPWD.value == "" || fmAdd.txtnewPWD.value == "" || fmAdd.selectPosition.value=="" || fmAdd.txtrenewPWD.value=="")
	{window.alert("UDSM Student Information System Asks You to Fill in the Blank Text Fields");
	return false;
	}
                      ...
                      <TD WIDTH=434 VALIGN=TOP ALIGN=LEFT>
                        <TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 WIDTH=284>
                          ...
                          <TR>
                            ...
                            <!-- chas edit-->
							<TD VALIGN=MIDDLE rowspan="2" ALIGN=LEFT><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000"><?php echo $row_changepassword['Position']; ?>
                            </font></div></TD>
                            <!-- before edit
