  ...
  // Add send functionality here
		...
		if(!empty($receiptno)){
			...
			if ($num_row > 0) {
			  ...
			  <fieldset>
				<legend>Caution Fee Registration Form</legend>
...
$qrefunded = "SELECT * FROM tblcautionfee WHERE (RegNo = '$key' AND Paytype='2') Order By Received Desc";
