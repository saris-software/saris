...
$query_studentsuggestion = "SELECT received, fromid, toid, message FROM suggestion WHERE toid = 'admin' ORDER BY received DESC";
  ...
  <center>
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#990000">
      ...
      <tr>
        ...
        <td><div align="left">Your Messages: <span class="style64">..........................................</span></div></td>
      ...
      <tr>
        <td width="672" valign="top"><div align="left">
          <table width="669" border="1" bordercolor="#990000">
		    ...
		    <p><a href="<?php printf("%s?pageNum_studentsuggestion=%d%s", $currentPage, max(0, $pageNum_studentsuggestion - 1), $queryString_studentsuggestion); ?>">Previous</a> Message: <?php echo min($startRow_studentsuggestion + $maxRows_studentsuggestion, $totalRows_studentsuggestion) ?> of <?php echo $totalRows_studentsuggestion ?> <span class="style64">...</span><a href="<?php printf("%s?pageNum_studentsuggestion=%d%s", $currentPage, min($totalPages_studentsuggestion, $pageNum_studentsuggestion + 1), $queryString_studentsuggestion); ?>">Next</a> <span class="style64">.......</span><?php echo "<a href=\"housingsuggestionbox.php?from=$from\">Reply Message</a>" ?></p>
        </div></td>
