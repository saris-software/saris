...
<FORM action="userlogin.php" method="post" onkeypress="return WebForm_FireDefaultButton(event, 'btnLogin')" id="idpform"
        ...
        <DIV class=loginOuterFormContents>
            ...
            <DIV class=loginInnerFormContents>
                ...
                <DIV class=loginButtonRow>
                    <div align="left">
                        <INPUT id=btnLogin
                               style="BORDER-TOP-WIDTH: 0px;border-radius: 4px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"
                               type=image src="login_files/btn_login.gif" name=btnLogin></div>
                </DIV>
                <p><?php
    ...
    <SCRIPT type=text/javascript>
            <![CDATA[
        WebForm_AutoFocus('txtUsername');]]></SCRIPT>
</FORM>
</BODY>
</HTML>
