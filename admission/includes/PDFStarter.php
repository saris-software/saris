...
if ($_SESSION['HTTPS_Only']==1){
	if ($_SERVER['HTTPS']!='on'){
		prnMsg('ZALONGWA is configured to allow only secure socket connections. Pages must be called with https:// ....','error');
		exit;
	}
}
*/
...
/** @var http\Client\Curl\Versions\ $Version */
$pdf->addinfo('Author','ZALONGWA ' . $Version);
$pdf->addinfo('Creator','ZALONGWA http://www.zalongwa.com');
