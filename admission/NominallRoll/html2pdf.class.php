...
if (!defined('__CLASS_HTML2PDF__'))
{
	...
	require_once('_mypdf/mypdf.class.php');	// classe mypdf dérivé de fpdf de Olivier PLATHEY 
	require_once('parsingHTML.class.php');	// classe de parsing HTML
	require_once('styleHTML.class.php');		// classe de gestion des styles
...
//			if ($this->style->value['height']) $h = $this->style->value['height'];
		...
		*/	
		...
		function textLOAD($langue)
		{
			...
			$file = './langues/'.strtolower($langue).'.txt';
			if (!is_file($file))
			{
