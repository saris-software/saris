...
require_once('../Connections/zalongwa.php'); 
	...
	*/
	...
	$j++;
        $arrStructure[$i]['subsections'][$j] = array( 'name1' => 'Register Student', 'name2' => 'Orodha ya Wanafunzi', 'url' => 'admissionRegistrationForm.php', 'width' => '', 'height' => '');
	$j++;
 ...
 $arrStructure[$i]['subsections'][$j] = array( 'name1' => 'Statistics', 'name2' => 'Tafuta Mwanafunzi', 'url' => 'admissionStatistics.php', 'width' => '', 'height' => '');
	$j++;
...
if ($privilege==2){
	...
	$arrStructure[$i]['subsections'][$j] = array( 'name1' => 'Admission Books', 'name2' => 'Formu ya Kuandikishwa', 'url' => './NominallRolls/NominallRoll.php', 'width' => '', 'height' => '');
	$j++;
