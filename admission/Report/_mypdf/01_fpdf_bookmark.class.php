...
require_once(dirname(__FILE__).'/00_fpdf_codebar.class.php');
	...
	class FPDF_BookMark extends FPDF_Codebar
	{
		...
		function CreateIndex(&$obj, $titre = "TABLE OF CONTENTS", $size_title = 20, $size_bookmark = 15, $bookmark_title = true, $display_page = true)
		{
			if ($bookmark_title) $this->Bookmark($titre, 0, -1);
			
			//Index title
			$this->SetFontSize($size_title);
			$this->Cell(0,5,"TABLE OF CONTENTS",0,1,'C');
