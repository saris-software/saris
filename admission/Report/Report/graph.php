...
$querys="select faculty.FacultyID as 'degree', COUNT(*) AS 'count' from student,faculty where student.Faculty=faculty.FacultyName GROUP BY student.faculty";
...
if($dent)
{
  ...
  //lines
	...
	//imagepng($img);
         imagejpeg( $img, "./images/graph.jpeg", 100);
        imagedestroy($img);
?>
