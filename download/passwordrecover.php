...
if (isset($_POST['Submit']) && $_POST['Submit'] !="") {
	...
	$sql=sprintf("SELECT student.DBirth,
					  ...
					  security.Position
                FROM security
                WHERE security.RegNo = '$userregno' AND security.DBirth = '$bdate'",
 		get_magic_quotes_gpc() ? $userregno : addslashes($userregno), get_magic_quotes_gpc() ? $bdate : addslashes($bdate)); 
		
		$result = @mysql_query($sql, $zalongwa) or die("query imeshindikana");
...
?>
              ...
              <table width="400" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
				 ...
				 <div align="center">You May Contact ZALONGWA HelpDesk <span class="style19"><br />
				   Website: <?php //echo $website?> http://www.zalongwa.com </span><br />
                   <span class="style19">E-Mail: <?php //echo $email?>support@zalongwa.com<br />
Tel.: <?php //echo $phone?>+255 222 18 11 38 <br />
Mobile: <?php //echo $phone?>+255 784 31 32 00</span></div>
                </form>
					<?php
