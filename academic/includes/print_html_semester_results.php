...
<table width="100%" height="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
        <td width="20" colspan="5" rowspan="2" nowrap scope="col">
            <div align="left"></div>
            CourseCode
        </td>
        <?php
    ...
    while ($rowstudent = mysqli_fetch_array($dbstudent)) {
        ...
        <tr>
            ...
            <td width="20" colspan="1" nowrap>
                <div align="left"></div><?php echo $name ?></td>
            <td width="20" colspan="1" nowrap>
                <div align="left"></div><?php echo $regno ?></td>
            <td width="20" colspan="1" nowrap>
                <div align="left"></div>
                <?php
                $examno = '';
                $num = mysqli_query($zalongwa, "SELECT DISTINCT ExamNo FROM examresult WHERE RegNo='$regno' AND AYear >= '$year' 
											AND Semester='$sem'");
            ...
            while ($row_courselist = mysqli_fetch_array($dbcourselist)) {
                ...
                ?>
                <td width="20" colspan="1" nowrap scope="col"><?php if ($checkwh == 'on') { /*if($due<=$debtorlimit){ */
                        echo $test2score; /*}*/
                    } else {
                        echo $test2score;
                    } ?></td>
            ...
            ?>
            <td width="13" colspan="1" nowrap>
                <div align="center"><?php /*if($due<=$debtorlimit){ */
                    echo $unittaken; /*}*/ ?></div>
            </td>
            <td width="13" colspan="1" nowrap>
                <div align="center"><?php /*if($due<=$debtorlimit){ */
