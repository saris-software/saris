...
while($rowsemester = mysql_fetch_object($dbsemester)){
	...
	if($module == 3){
		...
		$chekdue = mysql_query("SELECT * FROM studentremark WHERE RegNo='$RegNo' AND Semester='$currentsemester' 
...
<table width="100%" height="100%" border="1" cellpadding="0" cellspacing="0">
  ...
  <?php }?>
    ...
    <td width="31" nowrap scope="col"><div align="center"><?php echo $gpa = @substr($totalsgp/$unittaken, 0,3);?></div></td>
	  </tr>
     <tr><td colspan="3" style="text-align:right;"> <b>GPA Remark:</b> </td><td colspan="4">
                  <?php
