<?php
		...
		$pdf->line($x+186, $y, $x+186, $y+30);	$pdf->text($x+188, $y+12, 'Sex');
		$pdf->line($x+210, $y, $x+210, $y+30);	$pdf->text($x+212, $y+12, 'RegNo');
		//$pdf->line($x+310, $y, $x+310, $y+30);	$pdf->text($x+312, $y+12, 'CA/40'); //$pdf->text($x+312, $y+24, 'X/40');
		$pdf->line($x+340, $y, $x+340, $y+30);	$pdf->text($x+342, $y+12, 'CA/40'); //$pdf->text($x+342, $y+24, 'X/100');
		$pdf->line($x+373, $y, $x+373, $y+30);	$pdf->text($x+374, $y+12, 'SE/60'); //$pdf->text($x+374, $y+24, 'X/60');
		$pdf->line($x+400, $y, $x+400, $y+30);	$pdf->text($x+402, $y+12, 'Total'); //$pdf->text($x+402, $y+24, 'X/100');
		$pdf->line($x+430, $y, $x+430, $y+30);	$pdf->text($x+432, $y+12, 'Grade'); 
		...
		$pdf->line($x+340, $y, $x+340, $y+15);	$pdf->text($x+345, $y+12, $test2score);//$aescore100); 
		$pdf->line($x+373, $y, $x+373, $y+15);	$pdf->text($x+377, $y+12, $aescore);//$aescore);
