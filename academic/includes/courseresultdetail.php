...
$pdf->text($x + 190, $y + 13, 'HW1');
$pdf->text($x + 190, $y + 6, '');
$pdf->line($x + 210, $y, $x + 210, $y + 15);
$pdf->text($x + 214, $y + 13, 'HW2');
$pdf->text($x + 214, $y + 6, '');
$pdf->line($x + 234, $y, $x + 234, $y + 15);
$pdf->text($x + 236, $y + 13, 'QZ1');
$pdf->text($x + 236, $y + 6, '');
$pdf->line($x + 258, $y, $x + 258, $y + 15);
$pdf->text($x + 260, $y + 13, 'QZ2');
$pdf->text($x + 260, $y + 6, '');
$pdf->line($x + 282, $y, $x + 282, $y + 15);
$pdf->text($x + 284, $y + 13, 'GAS');
$pdf->text($x + 284, $y + 6, '');
$pdf->line($x + 304, $y, $x + 304, $y + 15);
$pdf->text($x + 306, $y + 13, 'PRO');
$pdf->text($x + 306, $y + 6, '');
$pdf->line($x + 328, $y, $x + 328, $y + 15);
$pdf->text($x + 330, $y + 13, 'CT1');
$pdf->text($x + 330, $y + 6, '');
$pdf->line($x + 352, $y, $x + 352, $y + 15);
$pdf->text($x + 354, $y + 13, 'CT2');
$pdf->text($x + 354, $y + 6, '');
$pdf->line($x + 374, $y, $x + 374, $y + 15);
$pdf->text($x + 375, $y + 12, 'CA/40');
$pdf->line($x + 398, $y, $x + 398, $y + 15);
$pdf->text($x + 399, $y + 12, 'SE/100');
$pdf->line($x + 422, $y, $x + 422, $y + 15);
$pdf->text($x + 423, $y + 12, 'SE/60');
$pdf->line($x + 446, $y, $x + 446, $y + 15);
$pdf->text($x + 448, $y + 12, 'Total');
$pdf->line($x + 470, $y, $x + 470, $y + 15);
$pdf->text($x + 472, $y + 12, 'Grade');
$pdf->line($x + 494, $y, $x + 494, $y + 15);
$pdf->text($x + 496, $y + 12, 'Remark');
...
while ($row_regno = mysqli_fetch_array($dbregno)) {
    ...
    $pdf->line($x + 186, $y, $x + 186, $y + 15);
    $pdf->text($x + 188, $y + 12, $hw1score);
    $pdf->line($x + 210, $y, $x + 210, $y + 15);
    $pdf->text($x + 212, $y + 12, $hw2score);
    $pdf->line($x + 234, $y, $x + 234, $y + 15);
    $pdf->text($x + 236, $y + 12, $qz1score);
    $pdf->line($x + 258, $y, $x + 258, $y + 15);
    $pdf->text($x + 260, $y + 12, $qz2score);
    $pdf->line($x + 282, $y, $x + 282, $y + 15);
    $pdf->text($x + 284, $y + 12, $gascore);
    $pdf->line($x + 304, $y, $x + 304, $y + 15);
    $pdf->text($x + 306, $y + 12, $proscore);
    $pdf->line($x + 328, $y, $x + 328, $y + 15);
    $pdf->text($x + 330, $y + 12, $ct1score);
    $pdf->line($x + 352, $y, $x + 352, $y + 15);
    $pdf->text($x + 354, $y + 12, $ct2score);
    $pdf->line($x + 374, $y, $x + 374, $y + 15);
    $pdf->text($x + 378, $y + 12, $test2score);
    $pdf->line($x + 398, $y, $x + 398, $y + 15);
    $pdf->text($x + 400, $y + 12, $aescore100);
    $pdf->line($x + 422, $y, $x + 422, $y + 15);
    $pdf->text($x + 424, $y + 12, $aescore);
    $pdf->line($x + 446, $y, $x + 446, $y + 15);
    $pdf->text($x + 448, $y + 12, $marks);
    $pdf->line($x + 470, $y, $x + 470, $y + 15);
    $pdf->text($x + 472, $y + 12, $grade);
    $pdf->line($x + 494, $y, $x + 494, $y + 15);
    $pdf->text($x + 496, $y + 12, $remark);
