<?php
				...
				$pdf->line($x+206, $y, $x+206, $y+15);	$pdf->text($x+211, $y+12, 'RegNo');
				
				$pdf->line($x+342, $y, $x+342, $y+15);	$pdf->text($x+347, $y+13, 'X/5'); $pdf->text($x+347, $y+6, 'HW1');
				$pdf->line($x+366, $y, $x+366, $y+15);	$pdf->text($x+371, $y+13, 'X/5'); $pdf->text($x+371, $y+6, 'HW2');
				$pdf->line($x+390, $y, $x+390, $y+15);	$pdf->text($x+395, $y+13, 'X/5'); $pdf->text($x+395, $y+6, 'QZ1');
				$pdf->line($x+414, $y, $x+414, $y+15);	$pdf->text($x+419, $y+13, 'X/5'); $pdf->text($x+419, $y+6, 'QZ2');
				$pdf->line($x+438, $y, $x+438, $y+15);	$pdf->text($x+443, $y+13, 'X/5'); $pdf->text($x+443, $y+6, 'GAS');
				$pdf->line($x+462, $y, $x+462, $y+15);	$pdf->text($x+467, $y+13, 'X/10'); $pdf->text($x+467, $y+6, 'PRO');
				$pdf->line($x+486, $y, $x+486, $y+15);	$pdf->text($x+491, $y+13, 'X/10'); $pdf->text($x+491, $y+6, 'CT1');
				$pdf->line($x+510, $y, $x+510, $y+15);	$pdf->text($x+515, $y+13, 'X/10'); $pdf->text($x+515, $y+6, 'CT2');
				$pdf->line($x+534, $y, $x+534, $y+15);	$pdf->text($x+536, $y+12, 'CA/40'); 
				
				$pdf->setFont('Arial', 'B', 10);
				$pdf->line($x+558, $y, $x+558, $y+15);	$pdf->text($x+563, $y+12, 'Comments');
				$pdf->line($x+620, $y, $x+620, $y+15);	$pdf->text($x+623, $y+12, 'Signature'); 
				$pdf->setFont('Arial', 'B', 7);
/*
...
*/
		...
		$pdf->line($x+30, $y, $x+30, $y+15);	$pdf->text($x+35, $y+12, $name);
		$pdf->line($x+206, $y, $x+206, $y+15);	$pdf->text($x+211, $y+12, $key);
		
		$pdf->line($x+342, $y, $x+342, $y+15);	$pdf->text($x+345, $y+12, $hw1score);
		$pdf->line($x+366, $y, $x+366, $y+15);	$pdf->text($x+369, $y+12, $hw2score);
		$pdf->line($x+390, $y, $x+390, $y+15);	$pdf->text($x+393, $y+12, $qz1score);
		$pdf->line($x+414, $y, $x+414, $y+15);	$pdf->text($x+417, $y+12, $qz2score);
		$pdf->line($x+438, $y, $x+438, $y+15);	$pdf->text($x+441, $y+12, $gascore);
		$pdf->line($x+462, $y, $x+462, $y+15);	$pdf->text($x+465, $y+12, $proscore);
		$pdf->line($x+486, $y, $x+486, $y+15);	$pdf->text($x+489, $y+12, $ct1score);
		$pdf->line($x+510, $y, $x+510, $y+15);	$pdf->text($x+513, $y+12, $ct2score);
		$pdf->line($x+534, $y, $x+534, $y+15);	$pdf->text($x+537, $y+12, $test2score); 
