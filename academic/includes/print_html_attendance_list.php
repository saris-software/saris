...
?>
	<table width="100%" height="100%" border="1" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<td width="60" colspan="1" nowrap scope="col"><div align="left"></div>Name</td>
	...
	while($result = mysql_fetch_array($querystd)) 
		{
			...
			if($due<=$debtorlimit){ 
				...
				if($checkrem=='on'){
				 ...
				 ?> 
				  <tr>
					<td width="10" colspan="1" nowrap scope="col"><?php echo $n; $n=$n+1; ?></td> 
					<td width="60" colspan="1" nowrap scope="col"><?php echo strtoupper(stripslashes($stname[0])).', '.ucwords(strtolower(stripslashes($stname[1])));  ?></td>
