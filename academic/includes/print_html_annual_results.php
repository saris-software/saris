...
<table width="100%" height="100%" border="1" cellpadding="0" cellspacing="0">
	  <tr>
		<td width="20" colspan="3" rowspan="2"nowrap scope="col"><div align="left"></div>CourseCode</td>
		<?php
		# print course header
		while($rowcourseheader = mysql_fetch_array($dbcolmns)) { 
		 ...
		 ?>
		<td width="52" rowspan="2" colspan="4" nowrap><div align="center">Semester II Remarks</div></td>
		<td width="52" rowspan="2" colspan="4" nowrap><div align="center">Semester I Remarks</div></td>
	  ...
	  <?php
		...
		{ 
					...
					if($checksem2==0){
						?>
						<td width="20" colspan="1" nowrap scope="col"><?php if ($sem1ovremark != 'ABSC') { if ($checkwh=='on'){ if($due<=$debtorlimit){ echo $test2score; } }else{ echo $test2score; } }?></td> 
						<td width="20" colspan="1" nowrap scope="col"><?php if ($sem1ovremark != 'ABSC') { if ($checkwh=='on'){ if($due<=$debtorlimit){ echo $aescore; } }else{ echo $aescore; } } ?></td>
						<td width="20" colspan="1" nowrap scope="col"><?php if ($sem1ovremark != 'ABSC') { if ($checkwh=='on'){ if($due<=$debtorlimit){ echo $marks; } }else{ echo $marks; } } ?></td>
						<td width="20" colspan="1" nowrap scope="col"><?php if ($sem1ovremark != 'ABSC') { if ($checkwh=='on'){ if($due<=$debtorlimit){ echo $grade; } }else{ echo $grade; } } ?></td>
						<?php 
		              }
					}
					$curr_semester=$semval;
					...
					$sem2avg=$avg;
					?>
					<td width="13" colspan="1" nowrap><div align="center"><?php if ($sem1ovremark != 'ABSC') { if($due<=$debtorlimit){ echo $sem2unittaken; } } ?></div></td>
					<td width="13" colspan="1" nowrap><div align="center"><?php if ($sem1ovremark != 'ABSC') { if($due<=$debtorlimit){ echo $sem2totalsgp; } }	?></div></td>
					<td width="13" colspan="1" nowrap><div align="center"><?php	if ($sem1ovremark != 'ABSC') { if($due<=$debtorlimit){ echo $sem2gpa; } } ?></div></td>
				...
				#check failed exam
					...
					if(($totalremarks>0)&&($studentremarks<>'')){
						...
						?>
							...
							<?php
									if($due<=$debtorlimit){ echo $sem1unittaken; } 
							
							?></div></td>
							<td width="13" colspan="1" nowrap><div align="center">
							
							<?php 
								if($due<=$debtorlimit){ echo $sem1totalsgp; } 
							?></div></td>
							<td width="13" colspan="1" nowrap><div align="center">
							
							<?php 
								if($due<=$debtorlimit){ echo $sem1gpa; } 
							?></div></td>
							<td width="13" colspan="1" nowrap><div align="center">
							<?php 
							if($due<=$debtorlimit){ 
			 ...
			 //  	include 'includes/sem1and2ovremark.php';
							...
							<?php 
								if($due<=$debtorlimit){ $ttunits=($sem2unittaken+$sem1unittaken); echo $ttunits; } 
							?></div></td>
							<td width="13" colspan="1" nowrap><div align="center">
							
							<?php 
								if($due<=$debtorlimit){ $ttsgp= ($sem2totalsgp+$sem1totalsgp); echo $ttsgp; } 
							?></div></td>
							<td width="13" colspan="1" nowrap><div align="center">
