...
if (isset($_POST['PrintPDF']) && ($_POST['PrintPDF'] == "Print PDF")) {
	...
	$qcert = mysql_query("SELECT programmecode FROM programme WHERE title LIKE '%certificate%'") or die(mysql_error());
	$qcertnum = mysql_num_rows($qcert);
	while($row_cert = mysql_fetch_assoc($qcert)){
