...
if ($auth_level =='user') {
	 	/*echo '<meta http-equiv = "refresh" content ="0; 
		url = lecturergradebook.php">';
		exit;*/
		$query_ExamOfficerGradeBook = "
		SELECT DISTINCT course.CourseCode, examresult.AYear, course.Department, examresult.SemesterID 
FROM examresult INNER JOIN course ON (examresult.CourseCode = course.CourseCode)
WHERE (examresult.AYear ='$ayear') AND (course.Department = '$dept') AND (RegNo='$username')  ORDER BY AYear DESC";
}

$currentPage = $_SERVER["PHP_SELF"];

$maxRows_ExamOfficerGradeBook = 100;
    ...
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="3" valign="top">
          <div align="left" class="style65">Examination Results Grade Book </div></td>
      </tr>
      <tr>
        <td height="112"></td>
        <td colspan="3" align="left" valign="top"><div align="left">
            <table width="100%"  border="1">
              <tr>
                ...
                <?php if ($auth_level =='editor') { ?> <td><span class="style34"><strong>Publish</strong></span></td>
                <?php } ?><td><span class="style34"><strong>Edit</strong></span></td>
              </tr>
              <?php do { ?>
              <tr>
               ...
               <?php if ($auth_level =='editor') {?>
			    <td><?php echo "<a href=\"lecturerexamofficerpublishresults.php?course=$course&ayear=$ayear&sem=$sem\">Publish</a>";?></td>
                <?php } ?>
