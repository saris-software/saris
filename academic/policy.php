...
-->
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller">
							<ul class="gn-menu">
								...
								<li><a href="lectureTimetable.php" name="menu5" class="gn-icon gn-icon-help">Timetable</a></li>
								<li>
							<a href="lecturerElearning.php" name="menu6" class="gn-icon gn-icon-archive">E-Lerning</a></li>
                            <li><a href="lecturercomm.php" name="menu4" class="gn-icon gn-icon-cog">Communication</a></li>
	...
	<li><a href="admissionFaculty.php" class='li-modal'>Faculty</a>
    </li>
	...
	<li><a href="admissionCombination.php" class='li-modal'>Combination</a>
    </li>
