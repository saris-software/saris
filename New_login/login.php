...
<body>
	<FORM action="newuserlogin.php" method="post" onkeypress="return WebForm_FireDefaultButton(event, 'btnLogin')" id="idpform"
      name="idpform">
			...
			<div class="wrap-login100 p-t-30 p-b-50">
				<div class="login100-form validate-form p-b-30 p-t-0">
					<span class="login100-form-title p-b-0">
						<img src="/saris/New_login/images/logo.png" alt="">
					</span>
