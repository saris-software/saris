...
$objPHPExcel->getProperties()->setCreator("Zalongwa")
	...
	while ($row = mysql_fetch_array($result)) {
			...
			$teach_type = mysql_fetch_array($result_teach);
	              // $exist_t = $row['day'].$row['start'].$row['end'];
			//if(! in_array($exist_t , $check_rep)){
...
#Set sheet style (fonts and font size)
	...
	//for ($i=7; $i< 20; $i++){
		$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'7:00 - 8:00');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);
$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'8:00 - 9:00');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);

$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'9:00 - 10:00');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);
$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'10:05 - 11:05');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);

$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'11:05 - 12:05');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);

$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'12:05 - 12:35');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);


$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'12:35 - 13:35');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);
$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'13:35 - 14:35');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);

$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'14:40 - 15:40');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);

$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'15:40 - 16:40');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);


$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows,'16:45 - 17:45');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);

$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows, '17:45 - 18:45');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);


$col++;
		$objPHPExcel->getActiveSheet()->getColumnDimension($col)->setWidth(12);
		$objPHPExcel->getActiveSheet()->setCellValue($col.$rows, '19:00 - 20:00');
		$objPHPExcel->getActiveSheet()->getStyle($col.$rows)->applyFromArray($style_header);
...
$kk++;
 ...
 if(array_key_exists($row['id'], $timetable)){
			...
			$kipind = $value['teaching']."\n". $value['course']."\n".$value['venue']."\n".$value['lecturer'];// $value['start'].':00 - '.$value['end'].':00'."\n". $value['lecturer'];
