...
//$query_studentsuggestion = "SELECT received, fromid, toid, message FROM news ORDER BY received DESC";
$query_studentsuggestion = "SELECT received, fromid, toid, message FROM news WHERE toid=6 or toid=7 ORDER BY received DESC";
...
<a href="admissionPostNews.php">Publish News and or Events</a><hr>
<table class="resView">
            <?php do { ?>
            <tr>
                <td class="resViewhd" width="61"><div align="right">Date:</div></td>
                <td class="resViewtd" width="703"><?php echo $row_studentsuggestion['received']; ?> - From: <?php echo $row_studentsuggestion['fromid']; ?></td>
            </tr>
            <tr>
