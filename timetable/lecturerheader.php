...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/header.css">
	 <link rel="stylesheet" type="text/css" href="../css/zalongwa_forms.css">
...
<table border="0" cellspacing="0" cellpadding='0' width='100%' background="../themes/images/loginTopHeaderBg.gif" style="border:2px solid rgb(119,119,119);height:100px;">
<tr>
	<td align=left style="filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#CCCCFF', endColorstr='#FFFFFF'); background: -moz-linear-gradient(top,  #CCCCFF,  #FFF); background: -webkit-gradient(linear, left top, left bottom, from(#CCCCFF), to(#FFF));" valign="middle"><span class="style5"><?php include '../includes/pagetitle.php'?></span></td>
</tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" width=100% height=100% style="border:2px solid rgb(119,119,119);">

<tr><td height=30 colspan=2 bgcolor="#DFDFDE" class="style2">
...
<tr>
    <td rowspan=2 width=180 valign=top align=center style="padding:5px" bgcolor="#DFDFDE"><span class="white"></span>
    ...
    <td valign=top style="font-size:12pt;"><div style="width:550;padding:15px 10px 50px 20px;">
