...
$v=array("Admission","Academic","Accommodation","Billing/Accounts","Database Administrator","Students","All");
for($k=0;$k<count($v);$k++)
{
	...
	<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" name="usersearch" id="usersearch">
		<table width="284" border="0">
			...
			<tr>
				...
				<td >
					<div align="center"><input type="submit" name="search" value="Search For Recepient"></div>
				</td>
			</tr>			
      </table>
    </form>
