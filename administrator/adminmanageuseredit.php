...
if (mysqli_num_rows($query) > 0) {
    ...
    echo "Sorry, No Records Found <br>";
    echo "That Match With Your Searck Key \"$key \" ";
>>>>>>> 367ba95229b9a770f067608e52240173bd533a1d
}
...
>>>>>>> 367ba95229b9a770f067608e52240173bd533a1d
            ...
            <tr>
                <td>
                    <div align="right"><strong>RegNo:</strong></div>
                </td>
            ...
            <tr>
                <td>
                    <div align="right"><strong>Position:</strong></div>
                </td>
            ...
            <tr>
                <td>
                    <div align="right"><strong>Module:</strong></div>
                </td>
...
=======
            ...
            <tr>
                <td>
                    <div align="right"><strong>Privilege:</strong></div>
                </td>
                <td><select name="priv" id="priv">
                        <option value="<?php echo $cuerrentprivilege ?>"
                                selected><?php echo $currentprivilege ?></option>
                        <?php
                        do {
                            ?>
                            <option value="<?php echo $row_privilege['privilegeID'] ?>"><?php echo $row_privilege['privilegename'] ?></option>
            ...
            <tr>
                <td>
                    <div align="right"><strong>Faculty:</strong></div>
                </td>
>>>>>>> 367ba95229b9a770f067608e52240173bd533a1d
            ...
            <tr>
                <td>
                    <div align="right"><strong>Update:</strong></div>
                </td>
