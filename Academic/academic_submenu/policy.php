...
# include the header
include('academic_submenu/policy.php');
...
-->
	...
	<body>
     ...
     <li><a href="./policy_setup/Newadmissionpolicy.php" class='li-modal'>medy</a>
    </li>
       
		            	 <li><a data-toggle="pill" href="#menu6">Combination</a></li>
                        <li><a data-toggle="pill" href="#menu5">Module</a></li>
						<li><a data-toggle="pill" href="#menu3">Department</a></li>
						<li><a data-toggle="pill" href="#menu2">Faculty</a></li>
                         <li><a data-toggle="pill" href="#menu4">Programme</a></li>
                         <li><a data-toggle="pill" href="#menu1">Institution</a></li>
