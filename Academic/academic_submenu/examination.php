			...
			<ul id="gn-menu" class="gn-menu-main">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
                         <ul class="nav navbar-nav">
		         		    ...
		         		    <li><a data-toggle="pill" href="#menu6">Grade book</a></li>
                            <li><a data-toggle="pill" href="#menu5">Course Result</a></li>
					     	<li><a data-toggle="pill" href="#menu3">Semister Result</a></li>
					    	<li><a data-toggle="pill" href="#menu2">Anual Result</a></li>
							<li><a data-toggle="pill" href="#menu6">Cand. Transaction</a></li>
                            <li><a data-toggle="pill" href="#menu5">Cand. Statement</a></li>
					     	<li><a data-toggle="pill" href="#menu3">Commulative POint</a></li>
					        <li><a data-toggle="pill" href="#menu4">Elective Course</a></li>
                            <li><a data-toggle="pill" href="#menu1">Graduate REport</a></li>
							<li><a data-toggle="pill" href="#menu6">Search Student</a></li>
