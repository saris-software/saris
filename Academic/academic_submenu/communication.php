...
-->
	...
	<body>
        ...
        <ul class="nav navbar-nav">
                  	<li><a data-toggle="pill" href="#menu3">Suggestion Box</a></li>
					<li><a data-toggle="pill" href="#menu5">Check Massage</a></li>
					<li><a data-toggle="pill" href="#menu6">News & Event</a></li>
