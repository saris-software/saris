...
if(!$nationality)
{
$nationality_error="<font color='red'>*Nationality Must be Filled</font>";
}
if(!$region)
{
...
global $disabilityCategory_erro,$studylevel_error,$maritalstatus_error,$nationality_error,$country_error,$ayear_error,$formsix_error,$formfour_error,$diploma_error,$dbirth_error,$date_error,$phone1_error,$email1_error,$regno_error,$degree_error,$faculty_error,$ayear_error,$combi_error,$campus_error,$manner_error,$byear_error,$bmon_error,$bday_error,$dtDOB_error,$surname_error,$firstname_error,$middlename_error,$dtDOB_error,$age_error,$sex_error,$sponsor_error,$nationality_error,$country_error,$district_error,$region_error,$maritalstatus_error,$address_error,$religion_error,$denomination_error,$postaladdress_error,$residenceaddress_error,$disability_error,$status_error,$gyear_error,$name_error;
...
$nm=mysqli_query($zalongwa,$query_campus);
while($show = mysqli_fetch_array($nm) )
{  										 
...
$nm=mysqli_query($zalongwa,$query_degree);
while($show = mysqli_fetch_array($nm) )
{  										 
...
$nm=mysqli_query($zalongwa,$query_faculty);
while($show = mysqli_fetch_array($nm) )
{  										 
...
?>
       ...
       <?php http://172.31.0.94:8090/saris/odbc.php
echo $sponsor_error;
?></td>
   </tr>
<tr>
...
$nm=mysqli_query($zalongwa,$query_studylevel);
while($show = mysqli_fetch_array($nm) )
{  										 
...
?></td>
  ...
  <td class='ztable'>
   <input name="firstname" type="text" value="<?php echo $firstname;?>" id="firstname" size="30" <?php echo $state3;?> <?php echo $state4;?>/>
...
<td class='ztable'>
<select name="nationality" <?php echo $state4;?>>
  <?php
if($nationality)
{
